...
export const asyncRouterMap = [
  ...
  },
  {
    ...
    children: [{
      path: 'index',
      component: _import('transactions/index'),
      name: 'transactions',
      meta: { title: 'transactions', icon: 'theme', noCache: true }
    }]
  },
  {
    path: '/thanks',
    ...
    children: [
      {
        path: 'index', component: _import('thanks/index'), name: 'sendForm', meta: { title: 'sendForm', icon: 'table' }
      }
    ]
  },
  // {
